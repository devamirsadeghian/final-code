...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// 🧠 جمع‌بندی سریع
// ✔️ JS خالص → سریع، مدرن، بدون وابستگی
// ✔️ jQuery → کوتاه‌تر، راحت‌تر برای پروژه‌های قدیمی
// ✔️ .on() در jQuery بهترین و کامل‌ترین روش است
// ✔️ addEventListener استاندارد دنیای مدرن است
